...
<section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex mt-8 flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
        ...
        <div class="w-full bg-gray-50 shadow-xl rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
				...
				<form  class="space-y-4 md:space-y-6" method="post" name="writeform" action="memRegisterPro.jsp">
                    <div>
					...
					<div>
                        ...
                        <input type="text" name="mem_name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="이름을 입력하세요." required>
                    </div>
					<div>
                        <label for="mem_tel" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">전화번호</label>
                        <input type="text" name="mem_tel" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="전화번호를 입력하세요." required>
                    </div>
                    <div>
					...
					<div>
                        ...
                        <input type="text" name="mem_model" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="스마트폰 기종을 입력하세요." required>
                    </div>
                ...
                <p class="text-sm font-light text-gray-500 dark:text-gray-400 text-right">
                    이미 가입 하셨나요? <a href="memLoginForm.jsp" class="font-medium hover:underline dark:text-primary-500 pl-3">로그인 하러가기</a>
                </p>
                <p class="text-sm font-light text-gray-500 dark:text-gray-400 text-right">
                    또는 <a href="../../developer/logon/developerLoginForm.jsp" class="font-medium hover:underline dark:text-primary-500 pl-3">개발자 회원가입</a>
                </p>
            </div>
        </div>
    </div>
