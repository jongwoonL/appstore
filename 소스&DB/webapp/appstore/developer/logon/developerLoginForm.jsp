    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
        ...
        <div class="w-full bg-gray-50 shadow-xl rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="post" action="developerLoginPro.jsp">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="password" name="passwd" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                ...
                <p class="text-sm font-light text-gray-500 dark:text-gray-400 text-right">
                    또는 <a href="../../member/logon/memLoginForm.jsp" class="font-medium hover:underline dark:text-primary-500 pl-3">일반 회원 로그인</a>
                </p>
            </div>
        </div>
    </div>
